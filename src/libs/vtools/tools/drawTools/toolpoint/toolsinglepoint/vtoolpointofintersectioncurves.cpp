...
void VToolPointOfIntersectionCurves::SaveDialog(QDomElement &domElement)
{
    ...
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrCurve1Name1, dialogTool->GetCurve1Name1(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrCurve1Name2, dialogTool->GetCurve1Name2(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrCurve2Name1, dialogTool->GetCurve2Name1(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrCurve2Name2, dialogTool->GetCurve2Name2(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
...
void VToolPointOfIntersectionCurves::SaveOptions(QDomElement &tag, QSharedPointer<VGObject> &obj)
{
    ...
    doc->SetAttributeOrRemoveIf<QString>(tag, AttrCurve1Name1, m_curve1Name1,
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(tag, AttrCurve1Name2, m_curve1Name2,
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(tag, AttrCurve2Name1, m_curve2Name1,
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(tag, AttrCurve2Name2, m_curve2Name2,
                                         [](const QString &name) noexcept { return name.isEmpty(); });
