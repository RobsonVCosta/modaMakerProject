...
void VToolCurveIntersectAxis::SaveDialog(QDomElement &domElement)
{
    ...
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrName1, dialogTool->GetName1(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrName2, dialogTool->GetName2(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
...
void VToolCurveIntersectAxis::SaveOptions(QDomElement &tag, QSharedPointer<VGObject> &obj)
{
    ...
    doc->SetAttributeOrRemoveIf<QString>(tag, AttrName1, m_name1,
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(tag, AttrName2, m_name2,
                                         [](const QString &name) noexcept { return name.isEmpty(); });
