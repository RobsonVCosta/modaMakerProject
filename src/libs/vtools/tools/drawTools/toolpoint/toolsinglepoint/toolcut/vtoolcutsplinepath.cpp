...
void VToolCutSplinePath::SaveDialog(QDomElement &domElement)
{
    ...
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrCurveName1, dialogTool->GetName1(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
    doc->SetAttributeOrRemoveIf<QString>(domElement, AttrCurveName2, dialogTool->GetName2(),
                                         [](const QString &name) noexcept { return name.isEmpty(); });
